export default {
  ...
  'manga.progression': '📚 Progression',
  'manga.last_chapter': 'Last chapter read',
  'manga.personal_rating': '⭐ Personal rating',
  'manga.my_review': '💭 My review',
  'manga.no_review': 'No review yet...',
  'manga.edit.button': 'Edit ✏️',
  ...
  'delete.account.item2': '• All your manga and their progress',
  ...
  'delete.account.final.message': 'All your lists, manga and data will be deleted. This action is irreversible.',

  // Delete data
  'delete.data.title': 'Delete data',
  'delete.data.confirm.title': '⚠️ Delete all data',
  'delete.data.confirm.message': 'All your lists and manga will be permanently deleted. Your account will be kept.',
