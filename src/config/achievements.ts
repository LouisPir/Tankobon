export type AchievementCategory = 'quantity' | 'completion' | 'rating' | 'lists' | 'diversity' | 'app' | 'import_export' | 'social';
...
export const GRADES: Grade[] = [
  ...
  { name: 'Silver',   nameKey: 'grade.silver',   icon: '🥈', minPoints: 200  },
  { name: 'Gold',     nameKey: 'grade.gold',     icon: '🥇', minPoints: 400  },
  { name: 'Platinum', nameKey: 'grade.platinum', icon: '💎', minPoints: 700  },
  { name: 'Diamond',  nameKey: 'grade.diamond',  icon: '💠', minPoints: 1000 },
  { name: 'Mythique', nameKey: 'grade.mythic',   icon: '🌟', minPoints: 1500 },
];
...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'stat_view',category: 'app',           icon: '📊', points: 10,  labelKey: 'ach.statview.label',   labelFr: 'Analyste',                   descriptionKey: 'ach.statview.desc',   descriptionFr: 'Consulter les statistiques' },
  ...
  // Social
  { id: 'soc_friend1', category: 'social', icon: '🤝', points: 20,  labelKey: 'ach.socfriend1.label',  labelFr: 'Premier ami',      descriptionKey: 'ach.socfriend1.desc',  descriptionFr: 'Ajouter un premier ami' },
  { id: 'soc_friend5', category: 'social', icon: '👥', points: 50,  labelKey: 'ach.socfriend5.label',  labelFr: 'Entouré',          descriptionKey: 'ach.socfriend5.desc',  descriptionFr: 'Avoir 5 amis' },
  { id: 'soc_share1',  category: 'social', icon: '🔗', points: 20,  labelKey: 'ach.socshare1.label',   labelFr: 'Généreux',         descriptionKey: 'ach.socshare1.desc',   descriptionFr: 'Partager une liste avec un ami' },
  { id: 'soc_copy1',   category: 'social', icon: '📋', points: 15,  labelKey: 'ach.soccopy1.label',    labelFr: 'Inspiré',          descriptionKey: 'ach.soccopy1.desc',    descriptionFr: 'Copier une liste partagée' },
];
